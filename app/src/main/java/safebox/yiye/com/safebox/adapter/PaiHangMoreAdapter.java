...
public class PaiHangMoreAdapter extends BaseAdapter {
	...
	public PaiHangMoreAdapter(Context context, String[] text_list) {
	...
	public View getView(int arg0, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			view = View.inflate(context, R.layout.item_paihang_morelist, null);
