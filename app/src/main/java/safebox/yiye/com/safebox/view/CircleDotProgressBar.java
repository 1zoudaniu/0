...
public class CircleDotProgressBar extends View{
    ...
    public CircleDotProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 获取自定义属性值或默认值
        progressMax = ta.getInteger(R.styleable.CircleDotProgressBar_progressMax, 25);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 1.1 当前进度
        while (count++ < percent) {
            mCanvas.drawCircle(mCenterX, mCenterY - outerRadius + dotRadius, dotRadius*3, mPaint);
            mCanvas.rotate(15f, mCenterX, mCenterY);
        }
        // 1.2 未完成进度
    ...
    public synchronized void setProgress(int progress) {
        ...
        percent = progress * 25 / progressMax;
