...
import safebox.yiye.com.safebox.exception.CustomException;
import safebox.yiye.com.safebox.utils.DensityUtils;
...
public class MyTabWidget extends LinearLayout {
    //R.drawable.bg_classify,
    private static final String TAG = "MyTabWidget";
    private int[] mDrawableIds = new int[]{R.drawable.rb_home_selector, R.drawable.rb_hotplace_selector,
            R.drawable.rb_realtime_selector};
    ...
    private void init(final Context context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (null != mTabListener) {
                        // tab项被选中的回调事件
                        mTabListener.onTabSelected(index, 0);
                    }
                }
            });
            ...
            if (i == 0) {
                ...
                itemName.setTextColor(Color.rgb(0, 206, 209));
                view.setBackgroundColor(Color.rgb(240, 241, 242));
            } else {
                itemName.setChecked(false);
                itemName.setTextColor(Color.rgb(171, 171, 171));
    ...
    public void setTabsDisplay(Context context, int index) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((Integer) (checkedTextView.getTag()) == index) {
                ...
                checkedTextView.setTextColor(Color.rgb(0, 206, 209));
                mViewList.get(i).setBackgroundColor(Color.rgb(240, 241, 242));
            } else {
                checkedTextView.setChecked(false);
                checkedTextView.setTextColor(Color.rgb(171, 171, 171));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        height = Math.max(DensityUtils.dp2dx(getContext(), 60),
                heightSpecSize);
    ...
    public interface OnTabSelectedListener {
        void onTabSelected(int index, int tag);
    }
